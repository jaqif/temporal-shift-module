...
3. Check if OpenCv 4.X is installed (it is now included in SD card image  until r32.3.1)
> Python3
>> Import cv2
>> cv2.__version__
It should show 4.X
...
cmake ..
make -j4
cp libtvm_topi.so /usr/local/lib/python3.6/dist-packages/tvm-0.6.0-py3.6-linux-aarch64.egg/tvm/
cd ..
